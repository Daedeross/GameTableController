...
int main(int argc, char *argv[]) {
    ...
    if (ret) {
        printf("Fail to convert characteristic RX to UUID.");
        return 1;
    }
    ...
    if (ret) {
        printf("Fail to discover characteristic.");
        return 1;
    }
    ...
    if (tx_handle == 0) {
        printf("Fail to find NUS TX characteristic.");
        return 1;
    } else if (rx_handle == 0) {
        printf("Fail to find NUS RX characteristic.");
        return 1;
    }
    ...
    while(1) {
        ...
        for (total_length = strlen(input) + 1; total_length > 0; total_length -= length) {
            ...
            if (ret) {
                printf("Fail to send data to NUS TX characteristic.");
                return 1;
            }
            input_ptr += length;
        }
